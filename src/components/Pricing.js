        ...
        <ul className="fa-ul">
          <li className={props.data.usersEnabler ? "" : "text-muted"}>
            <span className="fa-li ">
              <i
                className={
                  props.data.usersEnabler ? "fas fa-check " : "fas fa-times"
                }
              ></i>
            </span>
            <span className={props.data.fontWeight ? "fontThick" : ""}>
              {props.data.users}
            </span>
          </li>
          ...
          <li className={props.data.publicProjectsEnabler ? "" : "text-muted"}>
            <span className="fa-li">
              <i
                className={
          ...
          <li className={props.data.communityAccessEnabler ? "" : "text-muted"}>
            <span className="fa-li">
              <i
                className={
          ...
          <li className={props.data.privateProjectsEnabler ? "" : "text-muted"}>
            <span className="fa-li">
              <i
                className={
          ...
          <li className={props.data.subDomainEnabler ? "" : "text-muted"}>
            <span className="fa-li">
              <i
                className={
                  props.data.subDomainEnabler ? "fas fa-check" : "fas fa-times"
                }
              ></i>
            </span>
            <span className="fontThick">
              {props.data.subDomainUnlimit ? "Unlimited" : ""}
            </span>{" "}
            {props.data.subDomain}
          </li>
          <li className={props.data.statusReportsEnabler ? "" : "text-muted"}>
            <span className="fa-li">
              <i
                className={
                  props.data.statusReportsEnabler
                    ? "fas fa-check"
                    : "fas fa-times"
                }
              ></i>
            </span>
            {props.data.statusReports}
          </li>
        </ul>
